...
\begin{tabular}{x{2.8cm}|p{12cm}}
  ...
  \textsc{Summer 2015}& \textsc{KTH Royal Institute of Technology}, Stockholm, Sweden\\\multicolumn{2}{c}{}\\[-0.2cm]
...
\begin{tabular}{x{2.8cm}|p{12cm}}
  ...
  \textsc{Summer 2015}&\footnotesize{Developing a system to describe objects in a registered point cloud using 3D feature descriptors, and find query objects in the resulting feature database. Supervised by John Folkesson.}\\\multicolumn{2}{c}{}\\[-0.2cm]
...
\begin{center}
  \begin{tabular}{lll}
  Peter Ti{\v{n}}o& Patric Jensfelt & Kieren Feakes \\
  Professor  & Professor & Managing Director\\
  p.tino@cs.bham.ac.uk & patric@kth.se & klf@kaon.co.uk\\
  School of Computer Science& Centre for Autonomous Systems & Kaon Ltd  \rule{0pt}{0.6cm} \\
  University of Birmingham& Kungliga Tekniska H\"{o}gskolan & 5 Wey Court, Mary Road  \\
  Edgbaston, Birmingham & 100 44 & Guildford, Surrey \\
  B15 2TT, UK& Stockholm, Sweden &  GU1 4QU, UK
\end{tabular}
\end{center}
