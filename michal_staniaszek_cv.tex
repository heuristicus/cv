...
\begin{tabular}{x{2.8cm}|p{13cm}}
  ...
  \end{comment}
  \textsc{January 2016}&\footnotesize{Python and C++ development in ROS for a logistics robot. Worked on behaviour trees and behaviour design, diagnostics, simulation layer implementation and module interfacing. Made contributions to several ROS packages.}\\
...
\begin{tabular}{x{2.8cm}|p{13cm}}
  ...
  \textsc{June 2013}%& \small{Computer Science Prize (highest grade), Research Committee Project Prize (best dissertation)}\\
  ...
  \textsc{July 2012}& \small{Japanese Language Proficiency Test level N1 (Highest level)}\\
...
\begin{tabular}{x{2.8cm}|p{13cm}}
  \textsc{April 2019} to& \textbf{Warehouse Volunteer} at \textsc{Fareshare London}\\
  \textsc{Present} & \footnotesize{Sorted delivered food into categories and arranged in warehouse, picked required food for customer orders  }\\\multicolumn{2}{c}{} \\[-0.2cm]
  \textsc{May 2019} to& \textbf{Assistant Observer} at \textsc{Democracy Volunteers}\\
  \textsc{Present}&\footnotesize{Observed elections in the UK, Belgium and the Netherlands, completing surveys after visiting polling stations.}\\\multicolumn{2}{c}{} \\[-0.2cm]
\end{tabular}
