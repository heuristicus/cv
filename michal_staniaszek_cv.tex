...
\begin{tabular}{p{\descrlen}|p{\datelen}}
  ...
  \vspace{-0.4cm}
  \begin{itemize}
  \item Researched temporal methods in MDPs, wrote code to make building and simulation of MDPs more user friendly.
  ...
  \vspace{-0.4cm}
  \begin{itemize}
    \item Led development of robot-agnostic autonomy system used across the institute, integrating hardware and software.
    \item Ran demonstrations of Spot to the public, project funders, and industry, developed risk assessments and safety tools.
    \vspace{-0.5cm}
  \end{itemize}
  }&\textsc{Oct 2022}\\
  \multicolumn{2}{c}{} \\[-0.2cm]
  ...
  \vspace{-0.4cm}
  \begin{itemize}
  \item Administration of courses in computer vision and robotics, improved assignment structure and graded students.
  \item Reviewed literature on computer vision and mapping, evaluated performance of various state of the art algorithms.
  \vspace{-0.5cm}
  ...
  \small{
    \vspace{-0.4cm}
  \begin{itemize}
  \item Assisted researchers with robots through hardware and software support, network configuration, and status monitors.
  \item Improved usability of systems through scripting, user interfaces, and software package documentation.
  \vspace{-0.5cm}
  ...
  \small{
      \vspace{-0.4cm}
  \begin{itemize}
   \item Co-design and implementation of a software package for high-level robot control and state visualisation.
  \item Behaviour design, diagnostics, simulation, and module interfacing for an in-development robot.
  \vspace{-0.5cm}
  \end{itemize}
  }&\textsc{Jan 2016}\\
