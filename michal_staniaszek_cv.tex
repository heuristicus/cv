...
\begin{tabular}{x{\datelen}|p{\descrlen}}
  ...
  &Research focus: \emph{Long-Horizon Temporal Planning Under Uncertainty for Industrial Robotics}\multicolumn{2}{c}{}\\[-0.2cm]
  ...
  \textsc{Jun 2013}%& \small{Computer Science Prize (highest grade), Research Committee Project Prize (best dissertation)}\\
...
\begin{tabular}{x{\datelen}|p{\descrlen}}
  \textsc{July 2023}& \textbf{Staniaszek}, Brudermüller, Bhattacharyya, Lacerda, Hawes. \emph{Difficulty-aware Time-Bounded Planning Under Uncertainty for Large-Scale Robot Missions}. ECMR\\\multicolumn{2}{c}{}\\[-0.2cm]
  % &\small{
  % \vspace{-0.4cm}
  % \begin{itemize}
  % \item 
