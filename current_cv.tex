...
\begin{tabular}{x{2.5cm}|p{12cm}}
  ...
  to \textsc{July 2011}&\footnotesize{Worked alongside a PhD student to convert the AUV control system from Matlab to a new Python \textsc{ROS} system in preparation for \textsc{SAUC-E 2011}.}\\\multicolumn{2}{c}{}\\
