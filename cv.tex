...
\begin{tabular}{x{2.8cm}|p{12cm}}
  ...
  \textsc{April 2013}&\footnotesize{Answered questions about the implementation of various algorithms and the application of robotics techniques for use on LEGO NXT robots running LeJOS.}\\\multicolumn{2}{c}{}\\[-0.2cm]
...
I am looking for internship opportunities in software development or research,
particularly in the areas of artificial intelligence, machine learning and
robotics, and am available from \textbf{early June 2014 until mid-late August 2014}.

\begin{minipage}[t]{0.48\textwidth}
  \section{Programming and Software}
  \begin{tabular}{rp{0.7\textwidth}}
    Basic:& Bash, CUDA, Subversion, Lisp\\
    Intermediate:& C++, Emacs, Linux, ROS, Git, \LaTeX, Python\\
    Advanced:& C, Java
  \end{tabular}
  \vskip 0.2cm
  \centering
...
\begin{center}
  ...
  \textsc{email}: j.l.wyatt@cs.bham.ac.uk&\textsc{email}: p.tino@cs.bham.ac.uk & \textsc{email}: klf@kaon.co.uk\\
