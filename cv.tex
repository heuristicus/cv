...
\begin{tabular}{x{2.8cm}l}
  ...
  \textsc{e-mail:}     & \href{mailto:contact@michalstaniaszek.com}{contact@michalstaniaszek.com}\\
...
\begin{tabular}{x{2.8cm}|p{12cm}}
  ...
  &\footnotesize{One of five second year students selected to demonstrate for the First Year Workshop Java module. Provided advice on assignments, programming concepts, and the Java API.}\\
\end{tabular}

\section{Bursaries, Scholarships and Awards}
\begin{tabular}{x{2.8cm}|p{12cm}}
  \multirow{2}{*}{\textsc{June 2013}} & \textbf{Best Research Project}\\
  & \footnotesize{Awarded for my dissertation project by the University of Birmingham Computer Science department.}\\\multicolumn{2}{c}{} \\[-0.2cm]
...
Artificial intelligence, cycling, history of science, Japanese language and culture, languages, linux, music, photography, physics, science education.

\begin{minipage}[t]{0.48\textwidth}
  \section{Programming and Software}
  \begin{tabular}{rp{0.7\textwidth}}
    Basic:& Bash, CUDA, Subversion\\
