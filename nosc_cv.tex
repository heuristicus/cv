...
\titleformat{\subsubsection}{\centering\large}{}{0em}{}
\titlespacing{\subsection}{0pt}{3pt}{3pt}
...
\begin{tabular}{rl}
  Date of Birth: & 7 December 1990, London, UK \\
  Address:   & 36 Selby Road, London, W5 1LX\\
  Phone:     & +44 774 5916895\\
  e-mail:     & \href{mailto:m.staniaszek@gmail.com}{m.staniaszek@gmail.com}\\
  web:       & \url{www.github.com/heuristicus}
\end{tabular}
...
\begin{tabular}{x{3.2cm}|p{12cm}}
  July 2013 & BSc Computer Science with Study Abroad\\ & \textbf{University of Birmingham}, UK\\\multicolumn{2}{c}{}\\
  July 2012 & Japanese Language Programme\\ & \textbf{Keio University}, Tokyo, Japan\\\multicolumn{2}{c}{}\\
  July 2009& \textbf{St. Dominic's Sixth Form College}\\\multicolumn{2}{c}{}
...
\begin{tabular}{x{3.2cm}|p{12cm}}
  July 2011&Participant at \textbf{SAUC-E}\\
  ...
  January&Conversion of the \textbf{Delphin AUV} control system\\
  to July 2011&\footnotesize{Assisted a PhD student in the conversion of the AUV control system from Matlab to a new ROS system in preparation for SAUC-E 2011.}\\\multicolumn{2}{c}{}\\
  October 2010&Founding member of \textbf{Birmingham Autonomous Robotics Club}\\
  to July 2011&\footnotesize{Co-founded the club due to interest from faculty members and undergraduate students in working on programming tasks for intelligent robots. We worked on learning the ROS system in order to form a base of knowledge for future years.}\\\multicolumn{2}{c}{}
\end{tabular}

\section{Teaching}
\begin{tabular}{x{3.2cm}|p{12cm}}
  Sep 2010& Undergraduate Demonstrator at \\
  to April 2011&Department of Computer Science, University of Birmingham\\
...
\begin{tabular}{x{3.2cm}|p{12cm}}
December 2011& Hall staff at Gyu-Kaku (Tokyo, Japan)\\
  to June 2012
  ...
  Summer 2010& Technical Assistant at Japan Services Estate Agents\\
...
\begin{tabular}{x{3.2cm}|p{12cm}}
  January & Japan Student Services Organisation Scholarship\\
  to May 2012&\footnotesize{Scholarship for short-term study in Japan. Stipend of \yen 80,000 per month.}\\\multicolumn{2}{c}{} \\
  July & Nuffield Undergraduate Research Bursary\\
  to September 2011&\footnotesize{£1440 bursary to work on a research project to gain insight into scientific research careers.}
\end{tabular}
